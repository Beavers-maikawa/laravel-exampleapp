<x-app-layout>
    <div class="grid grid-cols-4">
        ...
        <div class="col-span-2 bg-white rounded p-4">
            <h2 class="text-2xl font-bold mb-2">新着のレシピ</h2>
            @foreach ($recipes as $recipe)
                <a href="{{route('recipe.show',['id' => $recipe->id])}}" class="flex flex-col items-center bg-white mb-6 border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100">
        ...
        <div class="col-span-1 ml-4 mb-6">
    ...
    <div class="grid grid-cols-4 mt-6">
        <div class="col-span-3 bg-white rounded p-4">
            ...
            @foreach ($popular as $p)
                <a href="{{route('recipe.show',['id' => $p->id])}}" class="max-w-full rounded overflow-hidden shadow-lg mx-4">
            ...
            <a href="#" class="text-gray-600 block text-right">すべての人気のレシピへ>></a>
        </div>
