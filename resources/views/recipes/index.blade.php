    ...
    <div class="grid grid-cols-3 gap-4">
        <div class="col-span-2 bg-white rounded p-4">
            ...
            @foreach ($recipes as $recipe)
                <a href="{{route('recipe.show',$recipe->id)}}" class="flex flex-col items-center bg-white mb-6 border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100">
        ...
        <div class="col-span-1 h-max bg-white p-4 sticky top-2">
            <form action="{{route('recipe.index')}}" method="GET">
                <div class="flex items-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">レシピ検索</h3>
                </div>
                <div class="mb-4 border border-gray-300 p-6">
                    <label class="text-lg text-gray-800">評価</label>
                    <div class="ml-4 mb-2">
                        <input type="radio" name="rating" value="0" id="rating0"
                        {{($filters['rating'] ?? null) == 0 ? 'checked' : ''}}/>
                ...
                <div class="mb-4 border border-gray-300 p-6">
                    <label class="text-lg text-gray-800">カテゴリ</label>
                ...
                <div class="text-center">    
                    <button type="submit" class="bg-green-600 text-white p-2 px-4 rounded">検索</button>
                </div>
            </form>
        </div>
    </div>
