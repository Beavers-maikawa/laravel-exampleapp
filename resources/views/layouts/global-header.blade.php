<section class="bg-white shadow">
    <div  class="container flex mx-auto justify-between items-center">
        ...
        <form action="{{route('recipe.index')}}" method="GET">
            <input type="text" name="title" class="border border-gray-300 rounded-lg px-3 py-2.5 ml-2 focus:outline-none focus:ring-4 focus:ring-green-300" placeholder="レシピを探す">
        ...
        <a href="{{route('recipe.create')}}" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded text-sm px-5 py-2.5 ml-2">レシピを投稿</a>
    </div>
</section>
